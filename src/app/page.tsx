...
export default function LandingPage() {
  ...
  <div id="about" data-section="about">
      ...
      bulletPoints={[
        ...
        },
        {
          ...
          description: "Используем передовые технологии для точной диагностики и эффективного ремонта.",
        },
        {
          title: "Гарантия Качества",
          description: "Предоставляем гарантию на все выполненные работы и установленные запчасти.",
        },
      ]}
      ...
      features={[
        {
          ...
          description: "Быстрый и качественный ремонт любой сложности, от двигателя до подвески.",
        },
        {
          icon: Car,
          title: "Плановое ТО",
          description: "Регулярное техническое обслуживание по регламенту производителя для долгой службы автомобиля.",
        },
        {
          icon: Gauge,
          title: "Компьютерная Диагностика",
          description: "Выявление скрытых неисправностей с помощью современного диагностического оборудования.",
        },
        {
          icon: Droplet,
          title: "Кузовной Ремонт и Покраска",
          description: "Восстановление геометрии кузова, устранение вмятин и царапин, покраска.",
        },
      ]}
      ...
      products={[
        {
          ...
          price: "от 1500 ₽",
          imageSrc: "http://img.b2bpic.net/free-photo/doctor-getting-ct-scan-machine-ready-use_23-2149367408.jpg",
          imageAlt: "Компьютерная диагностика двигателя",
        },
        {
          id: "p2",
          name: "Замена Масла",
          ...
          imageAlt: "Замена моторного масла",
        },
        {
          id: "p3",
          name: "Шиномонтаж",
        ...
        },
        {
          ...
          imageAlt: "Ремонт тормозов автомобиля",
        },
        {
          id: "p5",
          ...
          imageAlt: "Ремонт подвески автомобиля",
        },
        {
          id: "p6",
          name: "Покраска Детали",
          price: "от 6000 ₽",
          imageSrc: "http://img.b2bpic.net/free-photo/car-being-taking-care-workshop_23-2149580570.jpg",
          imageAlt: "Покраска кузовной детали",
        },
      ]}
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          id: "m3",
          icon: Car,
          title: "Отремонтированных Автомобилей",
          value: "25 000+",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          quote: "Очень довольна работой АвтоСервис Эксперт. Всегда качественно, быстро и по разумным ценам. Теперь только к ним!",
        ...
        },
        {
          ...
          quote: "Не в первый раз обращаюсь, всегда остаюсь очень доволен. Мастера грамотные, всегда все объяснят и покажут. Рекомендую!",
          tag: "Плановое ТО",
        ...
        },
        {
          ...
          quote: "Срочно нужен был ремонт, приняли без очереди, сделали все за несколько часов. Машина как новая! Спасибо огромное!",
          tag: "Кузовной ремонт",
        ...
        },
        {
          ...
          quote: "Доверяю свой автомобиль только этому сервису. Всегда честно, без навязывания лишних услуг. Молодцы!",
          tag: "Замена масла",
        ...
        },
        {
          ...
          quote: "Приезжаю сюда уже несколько лет. Всегда вежливый персонал и высокое качество работ. Рекомендую всем друзьям и знакомым.",
          tag: "Диагностика",
        ...
        },
        {
          ...
          quote: "Доступные цены и отличный уровень сервиса. Ребята знают свое дело, всегда помогут и подскажут. Очень рад, что нашел вас!",
          tag: "Ремонт подвески",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "Какие марки автомобилей вы обслуживаете?",
          content: "Мы обслуживаем большинство популярных марок автомобилей, как отечественных, так и импортных. Для уточнения по вашей конкретной модели, пожалуйста, свяжитесь с нами.",
        },
        {
          id: "q2",
          title: "Как долго длится ремонт?",
          content: "Время ремонта зависит от сложности поломки и наличия запчастей. Мы всегда стараемся выполнить работы максимально оперативно, предварительно согласовав сроки с клиентом.",
        },
        {
          id: "q3",
          title: "Вы даете гарантию на работы?",
          content: "Да, мы предоставляем гарантию на все выполненные работы и установленные запчасти. Срок гарантии оговаривается индивидуально.",
        },
        {
          id: "q4",
          title: "Можно ли привезти свои запчасти?",
          content: "Да, вы можете привезти свои запчасти. Однако, мы не несем ответственности за качество и совместимость ваших запчастей.",
        },
      ]}
      ...
      columns={[
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "info@autoservice.ru",
              href: "mailto:info@autoservice.ru",
            },
            {
              label: "ул. Примерная, 10, г. [Ваш Город]",
              href: "https://maps.google.com/?q=ул.+Примерная,+10,+г.+Ваш+Город",
            },
          ],
        },
      ]}
